...
echo ""
echo "Next steps:"
echo "  1. Use SDC_Agents API to create/reuse NIH-CDE components and assemble clusters"
echo "  2. In SDCStudio, approve draft components and build data models"
echo "  3. Generate all 8 output formats"
